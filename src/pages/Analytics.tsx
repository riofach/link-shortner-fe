...
const mockVisitorData = [
  { id: '1', timestamp: '2023-05-10, 14:32:45', ipAddress: '192.168.1.1', location: 'New York, US', device: 'Chrome / Windows', referrer: 'google.com' },
  { id: '2', timestamp: '2023-05-10, 13:21:18', ipAddress: '192.168.1.2', location: 'London, UK', device: 'Safari / macOS', referrer: 'twitter.com' },
  { id: '3', timestamp: '2023-05-10, 12:45:30', ipAddress: '192.168.1.3', location: 'Berlin, DE', device: 'Firefox / Windows', referrer: 'facebook.com' },
  { id: '4', timestamp: '2023-05-10, 11:12:05', ipAddress: '192.168.1.4', location: 'Paris, FR', device: 'Chrome / Android', referrer: 'instagram.com' },
  { id: '5', timestamp: '2023-05-10, 10:08:22', ipAddress: '192.168.1.5', location: 'Toronto, CA', device: 'Safari / iOS', referrer: 'linkedin.com' },
  { id: '6', timestamp: '2023-05-09, 22:45:18', ipAddress: '192.168.1.6', location: 'Sydney, AU', device: 'Edge / Windows', referrer: 'bing.com' },
  { id: '7', timestamp: '2023-05-09, 20:32:40', ipAddress: '192.168.1.7', location: 'Tokyo, JP', device: 'Chrome / Windows', referrer: 'yahoo.com' },
  { id: '8', timestamp: '2023-05-09, 18:15:52', ipAddress: '192.168.1.8', location: 'Mumbai, IN', device: 'Chrome / Android', referrer: 'direct' },
  { id: '9', timestamp: '2023-05-09, 16:05:34', ipAddress: '192.168.1.9', location: 'São Paulo, BR', device: 'Firefox / Linux', referrer: 'youtube.com' },
  { id: '10', timestamp: '2023-05-09, 15:22:17', ipAddress: '192.168.1.10', location: 'Mexico City, MX', device: 'Safari / iOS', referrer: 'direct' },
  { id: '11', timestamp: '2023-05-09, 13:48:29', ipAddress: '192.168.1.11', location: 'Amsterdam, NL', device: 'Chrome / macOS', referrer: 'google.com' },
  { id: '12', timestamp: '2023-05-09, 10:30:51', ipAddress: '192.168.1.12', location: 'Rome, IT', device: 'Safari / iOS', referrer: 'direct' },
];
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <Link to="/dashboard" className="inline-flex items-center text-gray-600 hover:text-primary mb-4">
